                            ...
                            <div class="tm-img-gallery-container">
                                ...
                                <!-- Gallery One pop up connected with JS code below -->                                    
                                    <div class="tm-img-gallery-info-container">                                    
                                        <h2 class="tm-text-title tm-gallery-title tm-white"><span class="tm-white">New Feature</span></h2>
                                        <?php
                                            $key = $_GET['keyword'];
                                            echo '<p class="tm-text">10 related questions of the keyword:'.$key.'</p>';
                                        ?>
                                    </div>
                                    <?php
                                        require 'conn.php';
                                        $sql = mysql_query("select * from $key");
